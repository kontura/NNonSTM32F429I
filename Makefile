...
CFLAGS  = -g -O0 -Wall -T./SW4STM32/STM32F429I-Discovery/STM32F429ZITx_FLASH.ld -DSTM32F429xx -DARM_MATH_CM4
CFLAGS += -mlittle-endian -mthumb -mcpu=cortex-m4 -mthumb-interwork
CFLAGS += -mfloat-abi=hard -mfpu=fpv4-sp-d16

###################################################

vpath %.c Src ${cube}/Drivers/STM32F4xx_HAL_Driver/Src/ ${cube}/Drivers/BSP/STM32F429I-Discovery/ ${cube}/Drivers/BSP/Components/ili9341/
